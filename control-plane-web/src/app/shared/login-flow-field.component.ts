...
@Component({
  selector: 'app-login-flow-field',
  template: `
    <div class="login-flow" aria-hidden="true">
      <div class="login-flow-wash"></div>
      <div class="login-flow-grid"></div>
      <svg class="login-flow-svg" viewBox="0 0 1440 900" preserveAspectRatio="xMidYMid slice">
        <defs>
          <linearGradient id="login-stroke" x1="0" y1="0" x2="1" y2="1">
            <stop offset="0%" stop-color="var(--login-line-a)" />
            <stop offset="100%" stop-color="var(--login-line-b)" />
          </linearGradient>
        </defs>
        <g class="login-flow-paths" fill="none" stroke="url(#login-stroke)" stroke-linecap="round">
        ...
        <g class="login-flow-packets" fill="var(--login-packet)">
          <circle r="4.2">
      ...
      <div class="login-flow-orb login-flow-orb-a"></div>
      <div class="login-flow-orb login-flow-orb-b"></div>
      <div class="login-flow-grain"></div>
    </div>
  `,
})
export class LoginFlowFieldComponent {}
